...
class Quiz : AppCompatActivity() {
    ...
    lateinit var option_a: Button
    lateinit var option_b: Button
    lateinit var option_c: Button
    lateinit var option_d: Button
    lateinit var buttonjawab_a: Button
    lateinit var buttonjawab_b: Button
    lateinit var buttonjawab_c: Button
    lateinit var buttonjawab_d: Button
    lateinit var buttonback: ImageButton
    lateinit var next: Button
    lateinit var soal: TextView
    lateinit var textView7: TextView
    lateinit var nomorlevel: TextView


    var questions = arrayOf(
        "1. Apa bahasa inggrisnya binding.merah?",
